...
fun main(){
    ...
    println("Понравилось "+outputNumberPeople(2));
    println("Понравилось "+outputNumberPeople(7));
    println("Понравилось "+outputNumberPeople(11));
